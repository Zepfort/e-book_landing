...
<section class="mr-[12vw] ml-[12vw] min-h-[700px] max-w-[1520px]">
    <h2 class="text-5xl font-bold mb-12">About the author</h2>
    <div class="flex ">
        <div class="w-1/2 mr-8 text-xl font-medium text-justify">
            <p>
