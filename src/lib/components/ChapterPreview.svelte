...
<section class="mr-[12vw] ml-[12vw] min-h-[800px] max-w-[1520px] px-0 pt-[80px]">
	<h2 class="text-6xl font-extrabold">What you're getting</h2>
	<div class="my-16 flex justify-between">
		<div class="w-[45%]">
			<ul class="">
				...
				<li>
					<button
						class="min-w-[450px] cursor-pointer border-b-1 border-gray-500 py-3 pr-10 pl-2 text-left"
		...
		<div class="pl-8 w-[50%]">
			<h3 class="pb-6 text-2xl leading-tight font-bold italic">
				{selectedChapter.title}
			</h3>
			<p class="text-xl font-medium text-gray-900 text-justify">
